...
l'ensemble de la population à une date donnée et génération d'une année 
donnée. 

Lorsqu'on cherche à reproduire les simulation de l'étude d'impact, nous 
avons besoin de données relative à l'année de départ en retraite. 
Une difficulté importante vient du fait que les graphiques de l'étude 
d'impact sont réalisés, au contraite, par génération. 
Dans l'étude d'impact, une génération correspond à l'ensemble des personnes 
nées la même année. 

La figure \ref{fig-trajectoire-vie} présente les générations de année 1940 
à 2010 environ, où nous avons utilisé les hypothèses du COR (Juin 2019).
Nous avons représenté par un point bleu l'année de naissance, par un point 
vert l'année de départ à la retraite et en rouge l'année de la 
mort. 
Pour calculer l'année de mort, nous avons utilisé l'espérance de vie à 60 ans 
selon les données du COR. 
